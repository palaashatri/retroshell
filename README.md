...
Captured from a Linux VM/Xvfb smoke run against a demo home directory after Finder status bar, path display, directory sorting, folder entry, and navigation-history behavior passed.
...
- `finder` under Linux/Xvfb/Mesa Vulkan llvmpipe against a demo home directory, including folder entry and refreshed path/status display
...
- Finder desktop: visible navigation controls, desktop integration, trash UI, surfaced file operations, drag/drop, contextual menus.
