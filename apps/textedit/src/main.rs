...
fn main() {
    ...
    }
    {
        ...
        item.with_shortcut(KeyCode::O, Modifiers { shift: false, control: false, alt: false, meta: true });
    }
    file_menu.add_separator();
    {
        let item = file_menu.add_action("Save");
        item.with_shortcut(KeyCode::S, Modifiers { shift: false, control: false, alt: false, meta: true });
    }
    ...
    let mut edit_menu = build_menu("Edit");
    {
        ...
        item.with_shortcut(KeyCode::Z, Modifiers { shift: false, control: false, alt: false, meta: true });
    }
    {
        let item = edit_menu.add_action("Redo");
        item.with_shortcut(KeyCode::Z, Modifiers { shift: true, control: false, alt: false, meta: true });
    }
    edit_menu.add_separator();
    {
        let item = edit_menu.add_action("Cut");
        item.with_shortcut(KeyCode::X, Modifiers { shift: false, control: false, alt: false, meta: true });
    }
    {
        let item = edit_menu.add_action("Copy");
        item.with_shortcut(KeyCode::C, Modifiers { shift: false, control: false, alt: false, meta: true });
    }
    {
        let item = edit_menu.add_action("Paste");
        item.with_shortcut(KeyCode::V, Modifiers { shift: false, control: false, alt: false, meta: true });
    }
    {
        let item = edit_menu.add_action("Select All");
        item.with_shortcut(KeyCode::A, Modifiers { shift: false, control: false, alt: false, meta: true });
    }
    edit_menu.add_separator();
    {
    ...
    app.set_menus(vec![file_menu, edit_menu, format_menu, view_menu, window_menu, help_menu]);
