use crate::{
    ...
    AccessibilityNode, AccessibilityRole, theme::ThemeContext,
};
...
impl ProgressBar {
    pub fn new() -> Self {
        Self { state: WidgetState::new(), value: 0.0, max: 100.0, indeterminate: false }
    }
}
...
impl Widget for ProgressBar {
    ...
    fn accessibility(&self) -> Option<AccessibilityNode> {
        Some(AccessibilityNode::new(AccessibilityRole::ProgressBar, "progress"))
    }
