...
Finder has sidebar, icon grid, sorted directory listing, status/path bar, visible Back/Forward/Up controls, folder entry, parent-folder navigation, back/forward history, visible New Folder/Duplicate/Trash controls, and file operation helpers. Definition done remains a full desktop environment: working Finder, TextEdit, Settings, Terminal, package-manager backed App Store, native dark mode, compositor/session path, HDR, VRR, and real application/game validation.
...
| App | Path | Status |
|-----|------|--------|
| Finder | `apps/finder/` | Prototype: menus, sorted file listing, status/path bar, visible Back/Forward/Up controls, visible New Folder/Duplicate/Trash controls, folder entry, parent/back/forward navigation, and file operation helpers exist; contextual menus, drag/drop, trash UI polish, real desktop integration, and polished multi-window workflows remain incomplete. |
...
2. Make Finder real: add contextual menus, drag/drop, trash UI polish, desktop integration, and polished multi-window workflows.
