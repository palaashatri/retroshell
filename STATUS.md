...
| retro-sdk | `crates/retro-sdk/` | First-party app runtime works for basic windows/menus/widgets; app lifecycle, dialogs, clipboard, platform services, and polished text rendering remain incomplete. |
...
| Settings | `apps/settings/` | Stub/prototype; persistent appearance/input/display controls remain incomplete. |
