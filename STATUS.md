...
| retro-shell | `crates/retro-shell/` | Prototype: rendered desktop, menu bar, shell services, and first managed shell windows exist; complete window controls, sessions, app lifecycle, compositor integration remain incomplete. |
...
| TextEdit | `apps/textedit/` | Stub/prototype; open/save, editing model, selection, clipboard, undo/redo remain incomplete. |
...
- `cargo test --workspace -q` (35 tests)
- `cargo clippy --workspace --all-targets -- -D warnings`
- Linux VM/Xvfb/Mesa Vulkan llvmpipe smoke: `retro-shell` starts, accepts pointer interaction, creates a second Finder-style managed shell window through the menu, and captures `docs/screenshots/current-retroshell-desktop.png`.
...
1. Finish shell window management: focus rings, multiple real app surfaces, close/zoom/minimize/fullscreen controls, modal dialogs, persisted placement.
